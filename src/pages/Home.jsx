...
const Home = () => {
  ...
  const processSteps = [
    {
      number: '01',
      title: 'Discovery',
      description: 'We analyze your requirements and create a comprehensive plan.',
      icon: '🔍'
    },
    {
      number: '02',
      title: 'Design',
      description: 'Our team creates intuitive and engaging designs for your solution.',
      icon: '✨'
    },
    {
      number: '03',
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Build powerful mobile applications that connect with your users on any device.",
      icon: "📱",
    ...
    },
    {
      ...
      description: "Develop scalable software solutions that streamline your business operations.",
      icon: "💻",
      image: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97",
      link: "/services/software-development",
      features: ["Custom Software", "Enterprise Solutions", "Cloud Applications"]
    },
    {
      title: "ERP & CRM Systems",
      description: "Integrate comprehensive ERP solutions to optimize your business processes.",
      icon: "🔄",
      image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40",
      link: "/services/erp-systems",
      features: ["Business Integration", "Process Automation", "Data Management"]
    },
    {
      title: "Software Maintenance",
      description: "Keep your software running smoothly with our comprehensive maintenance services.",
      icon: "🛠️",
      // path: '/services/software-maintenance',
      image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa",
      link: "/services/software-maintenance",
      features: ["Performance Optimization", "Security Updates", "24/7 Support"]
    },
    {
      title: "Digital Innovation",
      description: "Stay ahead with cutting-edge digital solutions and innovative technologies.",
      icon: "💡",
  ...
  const slides = [
    {
      ...
      description: "Leading the way in digital transformation with cutting-edge technology solutions",
      image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop"
    },
    {
      title: "Empowering Digital Growth",
      description: "Building scalable and sustainable solutions for businesses worldwide",
      image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=500&auto=format&fit=crop&q=60", // New Unsplash image URL
    },
    {
      title: "Future-Ready Solutions",
      description: "Transforming ideas into reality with advanced technology and expertise",
      image: "https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=500&auto=format&fit=crop&q=60", // New Unsplash image URL
    }
  ...
  const features = [
    {
      ...
      description: 'Utilizing cutting-edge technologies to deliver innovative solutions.'
    },
    {
      icon: (
        <svg className="w-8 h-8 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className="stat-number text-3xl sm:text-4xl lg:text-5xl font-bold text-primary-400 mb-2">{stat.number}</div>
                <div className="text-dark-200 text-sm sm:text-base">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {processSteps.map((step, index) => (
              <div
                ...
                data-aos-delay={index * 100}
              >
                <div className="process-number text-2xl sm:text-3xl font-bold text-primary-400 mb-3">{step.number}</div>
                <div className="text-3xl sm:text-4xl mb-4">{step.icon}</div>
                <h3 className="text-lg sm:text-xl font-bold mb-2">{step.title}</h3>
                <p className="text-dark-200 text-sm sm:text-base">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-dark-200 text-base sm:text-lg max-w-3xl mx-auto px-4">
              Comprehensive digital solutions tailored to transform your business vision into reality
            </p>
          </motion.div>
              ...
              >
                <div className="relative overflow-hidden rounded-xl bg-dark-800/50 backdrop-blur-sm border border-dark-700 h-full p-6 sm:p-8">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-dark-200 text-sm sm:text-base mb-6">{service.description}</p>
                    <ul className="space-y-2 mb-6">
                      {service.features.map((feature, idx) => (
                        <li key={idx} className="flex items-center text-sm sm:text-base text-dark-300">
                          <svg className="w-4 h-4 sm:w-5 sm:h-5 text-primary-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
