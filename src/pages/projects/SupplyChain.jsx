  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        {/* Dashboard Demo */}
        <div className="mb-20">
          <h2 className="text-3xl font-bold mb-8 text-primary text-center">Platform Dashboard</h2>
          <div className="bg-dark-800 rounded-xl p-8">
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <div className="text-gray-400">Supply Chain Dashboard</div>
              </div>
              <div className="h-64 flex items-center justify-center border-2 border-dashed border-gray-700 rounded-lg">
                <p className="text-gray-400">Interactive supply chain visualization</p>
              </div>
            </div>
          </div>
        </div>
