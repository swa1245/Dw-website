...
const Finance = () => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen w-screen bg-dark-900 text-white py-20 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-wrap gap-4">
                {technologies.map((tech, index) => (
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: index * 0.1 }}
                    className="bg-dark-800 px-4 py-2 rounded-full flex items-center space-x-2"
                  >
                    <span>{tech.icon}</span>
                    <span>{tech.name}</span>
                  </motion.div>
        ...
        <div className="mb-20">
          <h2 className="text-3xl font-bold mb-8 text-primary text-center">Live Market Overview</h2>
          <div className="bg-dark-800 rounded-xl p-6 h-96">
            <div className="h-full flex items-center justify-center">
              <p className="text-gray-400 text-lg">Interactive market visualization demo</p>
            </div>
          </div>
        </div>
