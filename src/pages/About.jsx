  ...
  const values = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?q=80&w=500&auto=format',
      icon: (
  ...
  const milestones = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=500&auto=format'
    },
    {
      year: '2021',
      title: 'Global Expansion',
      description: 'Opened offices in major tech hubs worldwide',
      image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=500&auto=format&fit=crop&q=60', // New Unsplash image URL
    },
    {
      year: '2023',
      title: 'Industry Leadership',
      description: 'Recognized as industry leader in digital transformation',
      image: 'https://images.unsplash.com/photo-1553877522-43269d4ea984?q=80&w=500&auto=format'
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-primary-400 mb-2">{stat.number}</div>
          ...
          <div className="space-y-12 sm:space-y-16">
            {milestones.map((milestone, index) => (
              <div
                ...
                data-aos-delay={index * 100}
              >
                <div className={`w-full sm:w-1/2 ${index % 2 === 0 ? 'sm:order-1' : 'sm:order-2'}`}>
                ...
                <div className={`w-full sm:w-1/2 ${index % 2 === 0 ? 'sm:order-2' : 'sm:order-1'} text-center sm:text-left`}>
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-400 mb-2">{milestone.year}</div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-3">{milestone.title}</h3>
                  <p className="text-dark-200 text-sm sm:text-base">{milestone.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 cta-section">
        <div className="container mx-auto px-4 cta-content text-center">
          ...
          <p 
            ...
            data-aos-delay="100"
          >
            Join us in creating innovative solutions that drive success in the digital age.
          </p>
          <Link
              to="/contact"
