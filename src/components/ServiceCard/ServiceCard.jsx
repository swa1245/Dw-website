...
const ServiceCard = ({ service, index }) => {
  return (
    <div
      className="group relative overflow-hidden rounded-xl bg-dark-800/50 backdrop-blur-sm border border-dark-700 transform hover:scale-105 transition-all duration-300"
      data-aos="fade-up"
